...
.stock-row:hover { background: color-mix(in srgb, var(--overlay) 50%, transparent); }
...
.watch-button:hover { background: color-mix(in srgb, var(--overlay) 60%, transparent); color: var(--ink); }
...
.watch-item:hover { background: color-mix(in srgb, var(--overlay) 68%, transparent); }
.watch-item.is-selected { background: color-mix(in srgb, var(--accent) 7%, transparent); border-color: color-mix(in srgb, var(--accent) 22%, transparent); }
...
.detail-link-btn:hover { background: color-mix(in srgb, var(--accent) 14%, transparent); }
...
.chart-grid-line {
  stroke: color-mix(in srgb, var(--line-tint) 40%, transparent);
  stroke-width: 1;
