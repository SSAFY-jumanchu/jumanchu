...
.cm-search {
  ...
  height: 36px;
  border-radius: 999px;
  background: color-mix(in srgb, var(--overlay) 62%, transparent);
...
.write-opt-btn:hover { background: color-mix(in srgb, var(--overlay) 75%, transparent); color: var(--ink); }
...
.write-cta-btn:hover { background: color-mix(in srgb, var(--accent) 18%, transparent); }
...
.follow-btn:hover { background: color-mix(in srgb, var(--accent) 14%, transparent); }
...
.more-btn:hover { background: color-mix(in srgb, var(--overlay) 60%, transparent); color: var(--ink); }
...
.chart-tag { font-size: 11px; font-weight: 700; color: color-mix(in srgb, var(--line-tint) 70%, transparent); }
.chart-source { font-size: 10px; font-weight: 700; color: color-mix(in srgb, var(--line-tint) 40%, transparent); }
...
.chart-x-labels {
  ...
  font-size: 10px;
  font-weight: 700;
  color: color-mix(in srgb, var(--line-tint) 60%, transparent);
}
...
.reaction-btn:hover { background: color-mix(in srgb, var(--overlay) 55%, transparent); color: var(--ink); }
...
.reaction-btn.is-active { background: color-mix(in srgb, var(--accent) 8%, transparent); color: var(--accent); }
...
.bookmark-btn:hover { background: color-mix(in srgb, var(--overlay) 55%, transparent); color: var(--ink); }
...
.comment-reply-btn:hover { background: color-mix(in srgb, var(--overlay) 50%, transparent); color: var(--muted); }
...
.popular-item:hover { background: color-mix(in srgb, var(--overlay) 48%, transparent); }
...
.topic-item:hover { background: color-mix(in srgb, var(--overlay) 48%, transparent); }
...
.topic-join-btn:hover { background: color-mix(in srgb, var(--accent) 14%, transparent); }
