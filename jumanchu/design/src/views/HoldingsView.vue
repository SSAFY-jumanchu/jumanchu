...
.status-dot.local { background: var(--accent); box-shadow: 0 0 0 3px color-mix(in srgb, var(--accent) 20%, transparent); }
...
.metric-tile.tone-blue { background: linear-gradient(145deg, color-mix(in srgb, var(--accent) 7%, transparent) 0%, rgba(255,255,255,.62) 55%); }
.metric-tile.tone-green { background: linear-gradient(145deg, color-mix(in srgb, var(--positive) 7%, transparent) 0%, rgba(255,255,255,.62) 55%); }
.metric-tile.tone-red { background: linear-gradient(145deg, color-mix(in srgb, var(--negative) 7%, transparent) 0%, rgba(255,255,255,.62) 55%); }
.metric-tile.tone-purple { background: linear-gradient(145deg, color-mix(in srgb, var(--purple) 7%, transparent) 0%, rgba(255,255,255,.62) 55%); }
...
.spark-up-card :deep(.sparkline-fill) { fill: color-mix(in srgb, var(--positive) 10%, transparent); }
.spark-down-card :deep(.sparkline-line) { stroke: var(--negative); }
.spark-down-card :deep(.sparkline-fill) { fill: color-mix(in srgb, var(--negative) 10%, transparent); }
