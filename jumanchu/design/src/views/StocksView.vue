...
.mdot.open { background: var(--positive); box-shadow: 0 0 0 2.5px color-mix(in srgb, var(--positive) 22%, transparent); }
...
.stock-row-data:hover { background: color-mix(in srgb, var(--overlay) 52%, transparent); }
...
.rate-pill.up { background: color-mix(in srgb, var(--positive) 12%, transparent); color: var(--positive); }
...
.buy-lbl { color: #0066CC; }
.sell-lbl { color: #FF3B5C; }
...
.spark-pos :deep(.sparkline-fill) { fill: color-mix(in srgb, var(--positive) 10%, transparent); }
...
.detail-go-btn:hover { background: color-mix(in srgb, var(--accent) 14%, transparent); }
...
.detail-close:hover { background: color-mix(in srgb, var(--overlay) 80%, transparent); color: var(--ink); }
...
.buy-text { color: #0066CC; }
.sell-text { color: #FF3B5C; }
