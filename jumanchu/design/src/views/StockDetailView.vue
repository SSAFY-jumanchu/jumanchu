...
.back-btn:hover { background: color-mix(in srgb, var(--overlay) 78%, transparent); color: var(--ink); }
...
.chart-tools span:hover { background: color-mix(in srgb, var(--overlay) 50%, transparent); color: var(--ink); }
...
.community-post:hover { background: color-mix(in srgb, var(--overlay) 48%, transparent); }
...
.hoga-row:hover { background: color-mix(in srgb, var(--overlay) 52%, transparent); }
...
.bid-bar { left: 0; background: color-mix(in srgb, var(--accent) 20%, transparent); }
...
.trade-row:hover { background: color-mix(in srgb, var(--overlay) 48%, transparent); }
...
.inv-history-row:hover { background: color-mix(in srgb, var(--overlay) 48%, transparent); }
...
.price-stepper button:hover { background: color-mix(in srgb, var(--overlay) 80%, transparent); }
...
.diary-inline-save-btn:hover:not(:disabled) { background: color-mix(in srgb, var(--accent) 20%, transparent); }
.diary-inline-save-btn:disabled { opacity: 0.4; cursor: default; }
.diary-inline-save-btn.is-saved { background: color-mix(in srgb, var(--positive) 14%, transparent); border-color: color-mix(in srgb, var(--positive) 30%, transparent); color: #059669; }
