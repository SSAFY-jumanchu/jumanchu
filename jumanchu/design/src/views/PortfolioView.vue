...
.stock-tab:hover { background: color-mix(in srgb, var(--overlay) 72%, transparent); color: var(--ink); }
...
.journal-row:hover { background: color-mix(in srgb, var(--overlay) 48%, transparent); }
...
.is-buy-text { background: color-mix(in srgb, var(--accent) 10%, transparent); color: #0066CC; }
