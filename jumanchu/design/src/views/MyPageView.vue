...
.ph-btn:hover { background: color-mix(in srgb, var(--overlay) 80%, transparent); }
.ph-btn.accent {
  background: color-mix(in srgb, var(--accent) 10%, transparent);
  border-color: color-mix(in srgb, var(--accent) 28%, transparent);
  color: var(--accent);
}
.ph-btn.accent:hover { background: color-mix(in srgb, var(--accent) 18%, transparent); }
...
.mp-menu-item:hover { background: color-mix(in srgb, var(--overlay) 60%, transparent); color: var(--ink); }
.mp-menu-item.active {
  background: color-mix(in srgb, var(--accent) 10%, transparent);
  color: var(--accent);
}
...
.edit-btn:hover { background: color-mix(in srgb, var(--accent) 15%, transparent); }
...
.retest-btn:hover { background: color-mix(in srgb, var(--overlay) 80%, transparent); color: var(--ink); }
...
.filter-tab {
  ...
  border: 1px solid var(--glass-border);
  background: color-mix(in srgb, var(--overlay) 40%, transparent);
...
.trade-table thead tr { background: color-mix(in srgb, var(--overlay) 40%, transparent); }
.trade-table th {
  padding: 12px 16px;
  text-align: left;
  font-size: 11px;
...
.trade-table tr:hover td { background: color-mix(in srgb, var(--overlay) 30%, transparent); }
...
.side-badge.buy { background: color-mix(in srgb, var(--accent) 12%, transparent); color: var(--accent); }
.side-badge.sell { background: color-mix(in srgb, var(--negative) 10%, transparent); color: var(--negative); }
...
.acc-btn:hover { background: color-mix(in srgb, var(--overlay) 80%, transparent); color: var(--ink); }
.acc-btn.accent {
  background: color-mix(in srgb, var(--accent) 10%, transparent);
  border-color: color-mix(in srgb, var(--accent) 28%, transparent);
  color: var(--accent);
}
.acc-btn.accent:hover { background: color-mix(in srgb, var(--accent) 18%, transparent); }
