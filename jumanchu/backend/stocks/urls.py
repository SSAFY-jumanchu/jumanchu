...
urlpatterns = [
    ...
    path('markets/period-stats/', views.PeriodStatsView.as_view(), name='markets-period-stats'),
    path('markets/status/', views.MarketStatusView.as_view(), name='markets-status'),
