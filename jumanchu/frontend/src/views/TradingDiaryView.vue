...
.cal-cell:not(.is-empty):hover { background: var(--glass); }
...
.cal-cell.has-entry { background: var(--glass-subtle); }
...
.modal-close:hover { color: var(--ink); background: var(--glass-strong); }
...
.type-btn:hover { background: var(--glass-strong); color: var(--ink); }
...
.cancel-btn:hover { background: var(--glass-strong); color: var(--ink); }
.submit-btn {
