...
.metric-tile.tone-blue { background: linear-gradient(145deg, rgba(49,93,255,.07) 0%, var(--glass) 55%); }
.metric-tile.tone-green { background: linear-gradient(145deg, rgba(15,159,110,.07) 0%, var(--glass) 55%); }
.metric-tile.tone-red { background: linear-gradient(145deg, rgba(207,61,61,.07) 0%, var(--glass) 55%); }
.metric-tile.tone-purple { background: linear-gradient(145deg, rgba(125,78,232,.07) 0%, var(--glass) 55%); }
.metric-tile.tone-amber { background: linear-gradient(145deg, rgba(184,120,0,.07) 0%, var(--glass) 55%); }
