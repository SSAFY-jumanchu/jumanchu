...
const holdings = [
  {
    ...
    scores: {
      ...
      total: { score: 86, grade: 'B+', label: '장기 보유 강력 추천', color: 'var(--krx-down)' },
    },
  },
  {
    ...
    scores: {
      ...
      total: { score: 80, grade: 'B+', label: '장기 보유 추천', color: 'var(--krx-down)' },
    },
  },
  {
  ...
  },
  {
    ...
    scores: {
      ...
      total: { score: 78, grade: 'B', label: '장기 보유 적합', color: 'var(--krx-down)' },
    },
  },
  {
          ...
          <div class="total-score-body">
            ...
            <div class="gauge-wrap">
              <svg viewBox="0 0 120 120" class="gauge-svg">
                ...
                <!-- 값 호 -->
                <circle cx="60" cy="60" r="48" fill="none"
                  :style="{ stroke: selectedHolding.scores.total.color }"
                  stroke-width="10"
...
.stock-tab:hover { background: var(--surface-hover); color: var(--ink); }
...
.journal-row:hover { background: var(--surface-soft); }
...
.is-buy-text { background: rgba(0,102,204,0.1); color: var(--krx-down); }
.is-sell-text { background: rgba(255,59,92,0.1); color: var(--krx-up); }
