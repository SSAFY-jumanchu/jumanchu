...
.stock-row:hover { background: rgba(255,255,255,0.5); }
...
.watch-button:hover { background: rgba(255,255,255,0.6); color: var(--ink); }
...
.watch-item:hover { background: rgba(255,255,255,0.68); }
