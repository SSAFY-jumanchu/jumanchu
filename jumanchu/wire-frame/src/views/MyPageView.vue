...
.ph-btn:hover { background: rgba(255,255,255,0.8); }
.ph-btn.accent {
...
.mp-menu-item:hover { background: rgba(255,255,255,0.6); color: var(--ink); }
.mp-menu-item.active {
  background: rgba(49,93,255,0.1);
  color: var(--accent);
}
...
.retest-btn:hover { background: rgba(255,255,255,0.8); color: var(--ink); }
...
.trade-table thead tr { background: rgba(255,255,255,0.4); }
.trade-table th {
  padding: 12px 16px;
  text-align: left;
  font-size: 11px;
...
.trade-table tr:hover td { background: rgba(255,255,255,0.3); }
...
.acc-btn:hover { background: rgba(255,255,255,0.8); color: var(--ink); }
.acc-btn.accent {
  background: rgba(49,93,255,0.1);
  border-color: rgba(49,93,255,0.28);
  color: var(--accent);
